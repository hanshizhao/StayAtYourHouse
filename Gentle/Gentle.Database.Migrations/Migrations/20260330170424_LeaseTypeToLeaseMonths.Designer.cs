...
namespace Gentle.Database.Migrations.Migrations
{
    ...
    [Migration("20260330170424_LeaseTypeToLeaseMonths")]
    partial class LeaseTypeToLeaseMonths
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Gentle.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DisplayName = "管理员",
                            IsEnabled = true,
                            PasswordHash = "$2a$11$fbucXYo9CpDZM9swfFPf3O5ILxpWd/at831ajC.9xpuR/khOYK3LO",
                            Username = "zhs"
                        });
                });
