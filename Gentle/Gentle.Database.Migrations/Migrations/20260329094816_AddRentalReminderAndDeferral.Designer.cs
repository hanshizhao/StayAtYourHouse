...
namespace Gentle.Database.Migrations.Migrations
{
    ...
    [Migration("20260329094816_AddRentalReminderAndDeferral")]
    partial class AddRentalReminderAndDeferral
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Gentle.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DisplayName = "管理员",
                            IsEnabled = true,
                            PasswordHash = "$2a$11$OsIruPvq3qmA8rK7IZu40uQSW.A9vecCjQUUJyaCpSyuEYNqFxvDm",
                            Username = "zhs"
                        });
                });
