...
namespace Gentle.Database.Migrations.Migrations
{
    ...
    [Migration("20260325025002_AddTenantAndRentalRecord")]
    partial class AddTenantAndRentalRecord
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Gentle.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DisplayName = "管理员",
                            IsEnabled = true,
                            PasswordHash = "$2a$11$WnhNjXmg41vVj.kYDtE/zOwXL/qpPoSF6tqDIATkAYL4/UrQcEbmy",
                            Username = "zhs"
                        });
                });
